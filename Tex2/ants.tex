...
While a registration algorithm that is totally ignorant of the
input data can only do so well, if you want a decent, fast registration you might run something like this:
...
embedded in the above call and they may not be appropriate for the
problem at hand; 3. you must have some facility with the command line
