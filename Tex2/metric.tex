...
The similarity type for the deformation transformation is specified by \verb -m  option, which contains two parts: simarity type and the parameters inside the brackets. The possible similarity metrics for volumetric images are: 
\begin{itemize}
    ...
    \item Mean square difference: \newline\texttt{-m
      ...
      \verb 0 is a padding value of no real meaning. For example, \texttt{-m MeanSquares[fixed.nii,moving.nii,1,0]}. 
