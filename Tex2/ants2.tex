...
ITK described in \cite{Tustison2008c}.  In addition to the built-in colormaps
which are currently part of ITK, we also have several custom colormaps located
in the directory \verb#${ANTSPATH}/Examples/CustomColormaps/#.
...
\subsection{Large-scale data inspection using {\tt CreateTiledMosaic}}
...
# Convert segmentation labels to irk-snap color map.  
